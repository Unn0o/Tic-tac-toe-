...
if __name__=='__main__':
    ...
    while 1:
        if len(taytetytX) + len(taytetytO) < 9:
            ...
            LCD.show() 
            if(vuoro % 2 != 0):
                LCD.text("VALITSE X",150,40,LCD.blue)
                if(key2.value() == 0):
                    LCD.text("X",x+6,y+6,LCD.blue)
                    vuoro += 1
                    taytetytX.append(kuutio)
                    print("X: ",taytetytX)
                    sendvalue(kuutio)
                    time.sleep(0.25)
                    voitto(taytetytX,"X")
                    LCD.text("VALITSE X",150,40,LCD.white)
                    jakojaamat.clear()
            else:
            ...
            LCD.show()
        elif (len(taytetytX) + len(taytetytO) == 9):
